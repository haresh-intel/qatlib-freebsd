 ...
 *******************************************************************************
 * @ingroup LacMem
 *      Macro from the osalMemAlloc() function
 *
 ******************************************************************************/
#define LAC_OS_MALLOC(sizeBytes) osalMemAlloc(sizeBytes)
    ...
    static const unsigned int highest_bit_of_##TYPE =                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
        (sizeof(TYPE) & 0x80000000                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
             ...
             : (sizeof(TYPE) & 0x40000000                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
                    ? 30                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        \
                    : (sizeof(TYPE) & 0x20000000                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \
                           ? 29                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
                           : (sizeof(TYPE) & 0x10000000                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         \
                                  ? 28                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          \
                                  : (sizeof(TYPE) & 0x08000000                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \
                                         ? 27                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
                                         : (sizeof(TYPE) & 0x04000000                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
                                                ? 26                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            \
                                                : (sizeof(TYPE) & 0x02000000                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
                                                       ? 25                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
