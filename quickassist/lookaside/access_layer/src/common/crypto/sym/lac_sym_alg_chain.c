...
static void LacAlgChain_buildCmdData(lac_session_desc_t *pSessionDesc,
    ...
    lac_session_desc_t *pSessionDesc)
{
    ...
    if (CPA_STATUS_SUCCESS == status)
    {
        ...
        LacAlgChain_updateLaCmdFlags(
            pSessionDesc, proto, &pSessionDesc->laCmdFlags);
...
static CpaStatus LacAlgChain_SPCSessionUpdate(
    const CpaInstanceHandle instanceHandle,
    lac_session_desc_t *pSessionDesc,
                              ...
                              CpaBoolean *pVerifyResult)
{
    ...
    status = LacAlgChain_SPCSessionUpdate(instanceHandle,
                                          pSessionDesc,
                                          pOpData,
                                          &cipher,
                                          &hash,
    ...
    if (CPA_STATUS_SUCCESS == status)
    {
            ...
            (laCmdId != ICP_QAT_FW_LA_CMD_CIPHER))
        {
            ...
            if (CPA_STATUS_SUCCESS == status)
            {
                ...
                if (CPA_TRUE == pSessionDesc->useStatefulSha3ContentDesc)
                {
