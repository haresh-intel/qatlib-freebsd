                            ...
                            icp_qat_fw_la_bulk_req_t *pCurrentQatMsg)
{
    ...
    if (pSessionDesc->isAuth)
    {
        ...
        /* We force a specific compiler optimisation here.  The length to
         * be copied turns out to be always 16, and by coding a memcpy with
         * a literal value the compiler will compile inline code (in fact,
         * only two vector instructions) to effect the copy.  This gives us
