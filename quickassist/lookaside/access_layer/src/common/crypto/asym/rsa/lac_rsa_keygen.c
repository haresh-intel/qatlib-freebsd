...
static const Cpa32U lacRsaKp1SizeIdMap[][LAC_PKE_NUM_COLUMNS] = {
    { LAC_512_BITS, PKE_RSA_KP1_512 },   { LAC_1024_BITS, PKE_RSA_KP1_1024 },
    { LAC_1536_BITS, PKE_RSA_KP1_1536 }, { LAC_2048_BITS, PKE_RSA_KP1_2048 },
    { LAC_3072_BITS, PKE_RSA_KP1_3072 }, { LAC_4096_BITS, PKE_RSA_KP1_4096 }
};
/**<
 *  Maps between operation sizes and PKE function ids */

static const Cpa32U lacRsaKp2SizeIdMap[][LAC_PKE_NUM_COLUMNS] = {
    { LAC_512_BITS, PKE_RSA_KP2_512 },   { LAC_1024_BITS, PKE_RSA_KP2_1024 },
    { LAC_1536_BITS, PKE_RSA_KP2_1536 }, { LAC_2048_BITS, PKE_RSA_KP2_2048 },
    { LAC_3072_BITS, PKE_RSA_KP2_3072 }, { LAC_4096_BITS, PKE_RSA_KP2_4096 }
};
/**<
 *  Maps between operation sizes and PKE function ids */
