                          ...
                          CpaFlatBuffer *pR)
{
    ...
    if (CPA_STATUS_SUCCESS == status)
    {
        ...
        compare = LacPke_Compare_Optimize(&(pOpData->k), &(pOpData->n), 0);
        if (compare >= 0)
        {
    ...
    if (CPA_STATUS_SUCCESS == status)
    {
        ...
        if (CPA_CY_EC_FIELD_TYPE_PRIME == pOpData->fieldType)
        {
            ...
            /* Ensure xg < q */
            compare = LacPke_Compare_Optimize(&(pOpData->xg), &(pOpData->q), 0);
            if (compare >= 0)
            {
            ...
            /* Ensure yg < q */
            compare = LacPke_Compare_Optimize(&(pOpData->yg), &(pOpData->q), 0);
            if (compare >= 0)
            {
                          ...
                          CpaFlatBuffer *pS)
{
    ...
    if (CPA_STATUS_SUCCESS == status)
    {
        ...
        compare = LacPke_Compare_Optimize(&(pOpData->r), &(pOpData->n), 0);
        if (compare >= 0)
        {
    ...
    if (CPA_STATUS_SUCCESS == status)
    {
        ...
        compare = LacPke_Compare_Optimize(&(pOpData->d), &(pOpData->n), 0);
        if (compare >= 0)
        {
                                   ...
                                   CpaFlatBuffer *pS)
{
    ...
    /* Return if not GEN4 */
    if (pCryptoService->generic_service_info.gen != GEN4)
                           ...
                           CpaBoolean *pVerifyStatus)
{
    ...
    if (CPA_STATUS_SUCCESS == status)
    {
        ...
        compare = LacPke_Compare_Optimize(&(pOpData->s), &(pOpData->n), 0);
        if (compare >= 0)
        {
    ...
    if (CPA_STATUS_SUCCESS == status)
    {
        ...
        {
            /* Ensure xp < q */
            compare = LacPke_Compare_Optimize(&(pOpData->xp), &(pOpData->q), 0);
            if (compare >= 0)
            {
            ...
            /* Ensure yp < q */
            compare = LacPke_Compare_Optimize(&(pOpData->yp), &(pOpData->q), 0);
            if (compare >= 0)
            {
