...
static const Cpa32U lacDHSizeIdMap[][LAC_PKE_NUM_COLUMNS] = {
    { LAC_768_BITS, PKE_DH_768 },   { LAC_1024_BITS, PKE_DH_1024 },
    { LAC_1536_BITS, PKE_DH_1536 }, { LAC_2048_BITS, PKE_DH_2048 },
    { LAC_3072_BITS, PKE_DH_3072 }, { LAC_4096_BITS, PKE_DH_4096 },
    { LAC_8192_BITS, PKE_DH_8192 }
};

/* Maps between operation sizes and PKE function ids */
static const Cpa32U lacDHG2SizeIdMap[][LAC_PKE_NUM_COLUMNS] = {
    { LAC_768_BITS, PKE_DH_G2_768 },   { LAC_1024_BITS, PKE_DH_G2_1024 },
    { LAC_1536_BITS, PKE_DH_G2_1536 }, { LAC_2048_BITS, PKE_DH_G2_2048 },
    { LAC_3072_BITS, PKE_DH_G2_3072 }, { LAC_4096_BITS, PKE_DH_G2_4096 },
    ...
    Cpa32U *pOpSizeInBytes)
{
    ...
    *pOpSizeInBytes = LacPke_GetMinBytes(&(pPhase1KeyGenData->primeP));
    ...
    if (LacPke_Compare_Optimize(
            &(pPhase1KeyGenData->baseG), &(pPhase1KeyGenData->primeP), 0) >= 0)
    {
    ...
    if (LacPke_Compare_Optimize(&(pPhase1KeyGenData->privateValueX),
                                &(pPhase1KeyGenData->primeP),
                                1) >= 0)
    {
    ...
    Cpa32U *pOpSizeInBytes)
{
    ...
    *pOpSizeInBytes = LacPke_GetMinBytes(&(pPhase2SecretKeyGenData->primeP));
    ...
    if (LacPke_Compare_Optimize(&(pPhase2SecretKeyGenData->privateValueX),
                                &(pPhase2SecretKeyGenData->primeP),
                                1) >= 0)
    {
        LAC_INVALID_PARAM_LOG("privateValueX must be < primeP - 1");
