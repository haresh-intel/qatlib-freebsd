...
static const Cpa32U lacGcdSizeIdMap[][LAC_PKE_NUM_COLUMNS] = {
    { LAC_160_BITS, PKE_GCD_PT_192 },   { LAC_192_BITS, PKE_GCD_PT_192 },
    { LAC_256_BITS, PKE_GCD_PT_256 },   { LAC_384_BITS, PKE_GCD_PT_384 },
    { LAC_512_BITS, PKE_GCD_PT_512 },   { LAC_768_BITS, PKE_GCD_PT_768 },
    { LAC_1024_BITS, PKE_GCD_PT_1024 }, { LAC_1536_BITS, PKE_GCD_PT_1536 },
    { LAC_2048_BITS, PKE_GCD_PT_2048 }, { LAC_3072_BITS, PKE_GCD_PT_3072 },
...
static const Cpa32U lacLucasSizeIdMap[][LAC_PKE_NUM_COLUMNS] = {
    { LAC_160_BITS, PKE_LUCAS_PT_160 },   { LAC_512_BITS, PKE_LUCAS_PT_512 },
    { LAC_768_BITS, PKE_LUCAS_PT_768 },   { LAC_1024_BITS, PKE_LUCAS_PT_1024 },
    { LAC_1536_BITS, PKE_LUCAS_PT_1536 }, { LAC_2048_BITS, PKE_LUCAS_PT_2048 },
    { LAC_3072_BITS, PKE_LUCAS_PT_3072 }, { LAC_4096_BITS, PKE_LUCAS_PT_4096 }
};
/**<
 * Maps between operation sizes and Lucas PKE function ids */

static const Cpa32U lacMrSizeIdMap[][LAC_PKE_NUM_COLUMNS] = {
    { LAC_160_BITS, PKE_MR_PT_160 },   { LAC_512_BITS, PKE_MR_PT_512 },
    { LAC_768_BITS, PKE_MR_PT_768 },   { LAC_1024_BITS, PKE_MR_PT_1024 },
    { LAC_1536_BITS, PKE_MR_PT_1536 }, { LAC_2048_BITS, PKE_MR_PT_2048 },
    { LAC_3072_BITS, PKE_MR_PT_3072 }, { LAC_4096_BITS, PKE_MR_PT_4096 }
};
/**<
...
CpaStatus LacPrime_Init(CpaInstanceHandle instanceHandle)
{
    ...
    pCryptoService->pLacPrimeStatsArr =
        LAC_OS_MALLOC(LAC_PRIME_NUM_STATS * sizeof(OsalAtomic));
