                                  ...
                                  sal_service_t *service)
{
    ...
    pCompressionService->generic_service_info.device = device;
#endif
    ...
    if (CPA_TRUE == pStatsCollection->bDcStatsEnabled)
    {
        ...
        status = icp_adf_debugAddFile(device, pCompressionService->debug_file);
        if (CPA_STATUS_SUCCESS != status)
        {
            Lac_MemPoolDestroy(pCompressionService->compression_mem_pool);
                                      ...
                                      sal_service_t *service)
{
    ...
    pCompressionService->generic_service_info.device = NULL;
#endif
...
/* Check parameters */
    ...
    pInstanceCapabilities->batchAndPack = (CpaBoolean)pExtendedFtrs->is_bnp;
#endif
#ifndef ICP_DC_BNP_SUPPORTED
