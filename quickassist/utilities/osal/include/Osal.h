 ...
 */
#if defined(__FreeBSD__) && !defined(ICP_OSAL_MEMOPS)

#ifndef KERNEL_SPACE
#include <string.h>
#endif
#define osalMemCopy(d, s, l) memcpy(d, s, l)
#define osalMemSet(p, f, c) memset(p, f, c)
 ...
 *
 */
OSAL_PUBLIC OSAL_STATUS osalAdler32(UINT32 *checksum,
                                    UINT8 *buffer,
                                    UINT32 length);
 ...
 *
 */
OSAL_PUBLIC OSAL_STATUS osalZlibInflate(void *srcBufferList,
                                        void *destBufferList,
                                        UINT32 *produced,
                                        UINT32 checksumType,
                                        UINT32 *checksum,
 ...
 *
 */
OSAL_PUBLIC OSAL_STATUS osalMakeBankE(void *ctxBufferList,
                                      void *literal,
                                      void *distances,
                                      INT32 *nlit,
                                      INT32 *ndist,
 ...
 *
 */
OSAL_PUBLIC OSAL_STATUS osalCreateHuffmanTable(void **huffman_table);
 ...
 *
 */
OSAL_PUBLIC OSAL_STATUS osalDestroyHuffmanTable(void **huffman_table);

#endif /* ZLIB_TREE_CALCULATION */
       /**
        * @ingroup Osal
        *
 ...
 * @ingroup Osal
 *
 * @brief  Osal Service Initiation function
 *
 * @param  void
 *
 * @li Reentrant: yes
 ...
 * @return - void
 */
void OsalServicesInit(void);

/**
 * @ingroup Osal
 *
 * @brief  Osal Service Un-initiation function
 *
 * @param  void
 *
 * @li Reentrant: yes
